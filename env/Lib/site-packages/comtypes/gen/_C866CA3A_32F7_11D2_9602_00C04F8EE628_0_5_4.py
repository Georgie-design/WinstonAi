...
__all__ = [
    'SAFT24kHz16BitStereo', 'STCInprocServer', 'SPRST_ACTIVE',
    'DISPID_SpeechPhraseRule', 'DISPID_SDKSetBinaryValue', 'SPSLMA',
    'SpeechPropertyNormalConfidenceThreshold', 'ISpeechRecoResult2',
    'SpeechRunState', 'SVSFNLPSpeakPunc', 'SAFTCCITT_uLaw_22kHzMono',
    'SpSharedRecognizer', 'SVSFIsFilename',
    'SpeechRecoProfileProperties', 'SDTLexicalForm',
    'DISPID_SpeechPhraseReplacement', 'DISPID_SRRDiscardResultInfo',
    'DISPID_SPEAudioSizeBytes', 'eLEXTYPE_RESERVED8',
    'SAFTCCITT_ALaw_22kHzMono', 'ISpeechPhraseProperty',
    'SpMemoryStream', 'SpeechPropertyLowConfidenceThreshold',
    'SAFT12kHz8BitStereo', 'DISPID_SPIGetDisplayAttributes',
    'DISPID_SRGSetWordSequenceData', 'SPEI_SOUND_START',
    'SPCT_SUB_COMMAND', 'SAFT8kHz8BitStereo', 'DISPID_SRDisplayUI',
    'SPEI_SR_AUDIO_LEVEL', 'DISPID_SGRSTWeight',
    'SPWT_LEXICAL_NO_SPECIAL_CHARS', 'SAFTCCITT_ALaw_11kHzMono',
    'eLEXTYPE_LETTERTOSOUND', 'DISPID_SVEAudioLevel',
    'DISPID_SVSLastBookmarkId', 'SP_VISEME_8',
    'SpeechAudioFormatGUIDWave', 'ISpEventSource', 'SDTDisplayText',
    'DISPID_SLPPartOfSpeech', 'SPBO_TIME_UNITS', 'SGSDisabled',
    'DISPID_SGRName', 'DISPID_SABIEventBias', 'SGDisplay',
    'eLEXTYPE_PRIVATE16', 'DISPID_SVSLastStreamNumberQueued',
    'ISpeechLexiconWord', 'DISPID_SOTCSetId',
    'SPSMF_SRGS_SAPIPROPERTIES', 'SPPS_SuppressWord',
    'DISPID_SRRSpeakAudio', 'DISPID_SRCState', 'SPSHORTCUTTYPE',
    'ISpStreamFormat', 'DISPID_SRSetPropertyString',
    'ISpeechRecoResult', 'DISPID_SRGIsPronounceable',
    'SDKLCurrentConfig', 'DISPID_SOTGetDescription', 'SPVPRI_NORMAL',
    'DISPID_SVResume', 'SPEI_HYPOTHESIS', 'SBOPause',
    'DISPID_SGRsFindRule', 'SP_VISEME_16', 'STSF_AppData',
    'SpPhoneConverter', 'DISPID_SLWType', 'eLEXTYPE_PRIVATE8',
    'SpeechRecognizerState', 'SPEI_END_SR_STREAM',
    'DISPID_SRCEHypothesis', 'SAFTADPCM_8kHzStereo',
    'ISpeechPhraseElements', 'DISPID_SPEsCount',
    'SpeechRetainedAudioOptions', 'SAFT48kHz16BitMono',
    'SPCT_SUB_DICTATION', 'DISPID_SVEStreamStart',
    'SECNormalConfidence', 'ISpEventSink', 'SBONone',
    'DISPID_SpeechPhraseProperties', 'SpMMAudioOut', 'SREAllEvents',
    'DISPID_SRRAudio', 'DISPID_SpeechRecognizerStatus', 'SVP_16',
    'SVEVoiceChange', 'DISPID_SOTSetId',
    'SpeechPropertyResponseSpeed', 'DISPID_SDKSetStringValue',
    'DISPID_SGRsCommit', 'ISpeechAudioStatus',
    'DISPID_SpeechObjectToken', 'ISpVoice', 'eLEXTYPE_USER',
    'WAVEFORMATEX', 'tagSTATSTG', 'DISPID_SpeechPhraseProperty',
    'SPEI_RESERVED3', 'SAFT24kHz8BitMono', 'DISPID_SWFEBitsPerSample',
    'DISPID_SPIEnginePrivateData', 'SPSMF_SAPI_PROPERTIES',
    'DISPID_SVGetProfiles', 'DISPID_SRCERequestUI', 'SP_VISEME_2',
    'ISpRecoGrammar2', 'ISpeechLexiconPronunciation',
    'SpStreamFormatConverter', 'DISPID_SGRId', 'ISpeechFileStream',
    'DISPID_SPAStartElementInResult', 'SPCATEGORYTYPE',
    'ISpeechPhraseInfo', 'SGSExclusive', 'SPRS_INACTIVE',
    'DISPID_SPISaveToMemory', 'eWORDTYPE_DELETED',
    'DISPID_SRSAudioStatus', 'DISPID_SRSNumberOfActiveRules',
    'SpeechBookmarkOptions', 'SPAR_High', 'DISPID_SVGetVoices',
    'DISPID_SRRSaveToMemory', 'SpeechTokenKeyUI',
    'SPWP_KNOWN_WORD_PRONOUNCEABLE', 'DISPIDSPTSI_ActiveLength',
    'SPWP_UNKNOWN_WORD_PRONOUNCEABLE', 'SpeechEngineProperties',
    'DISPID_SpeechGrammarRuleStateTransitions',
    'DISPID_SRCEPhraseStart', 'SPINTERFERENCE_LATENCY_WARNING',
    'ISpeechGrammarRules', 'SPRECOGNIZERSTATUS',
    'DISPID_SPIReplacements', 'SGRSTTWildcard', 'DISPID_SPAsItem',
    'SVP_8', 'Speech_StreamPos_Asap', 'SPLOADOPTIONS',
    'DISPID_SRCEEnginePrivate', 'SGRSTTEpsilon', 'SREStreamEnd',
    'ISpeechGrammarRuleStateTransitions', 'DISPID_SVDisplayUI',
    'SGLexicalNoSpecialChars', 'SpeechGrammarTagUnlimitedDictation',
    'SpeechCategoryVoices', 'DISPID_SDKSetLongValue',
    'eLEXTYPE_PRIVATE18', 'SpeechRuleAttributes',
    'DISPID_SOTCreateInstance', 'DISPID_SWFEFormatTag', 'SAFTText',
    'DISPID_SABufferNotifySize', 'LONG_PTR', 'DISPID_SOTCategory',
    'DISPID_SRRTLength', 'DISPID_SRRPhraseInfo',
    'SpeechTokenShellFolder', 'DISPID_SPACommit', 'SVPAlert',
    'ISpeechBaseStream', 'SPWF_INPUT', 'SPFM_CREATE_ALWAYS',
    'DISPID_SRCSetAdaptationData', 'DISPID_SPCLangId',
    'SpNullPhoneConverter', 'ISpPhoneticAlphabetConverter',
    'SAFT11kHz16BitMono', 'SpeechAudioFormatGUIDText', 'SRTReSent',
    'SPINTERFERENCE_TOOLOUD', 'SpeechEmulationCompareFlags',
    'SP_VISEME_1', 'SDKLCurrentUser', 'SGRSTTTextBuffer',
    'SAFT22kHz8BitMono', 'DISPID_SRCEStartStream', 'SINone',
    'DISPID_SVIsUISupported', 'SECFIgnoreCase', 'SGRSTTRule',
    'DISPID_SPERequiredConfidence', 'SpCompressedLexicon',
    'DISPID_SpeechCustomStream', 'SAFT24kHz16BitMono',
    'DISPID_SAVolume', 'DISPID_SVSkip', 'eLEXTYPE_USER_SHORTCUT',
    'SAFT12kHz8BitMono', 'SWTDeleted', 'DISPID_SVVolume', 'SPAS_STOP',
    'SDA_One_Trailing_Space', 'SpeechStreamFileMode',
    'SpeechTokenContext', 'SPEI_FALSE_RECOGNITION',
    'ISequentialStream', 'ISpeechRecognizerStatus',
    'SpeechDiscardType', 'SINoSignal', 'SAFT8kHz16BitStereo',
    'DISPID_SRRTimes', 'DISPID_SpeechGrammarRules',
    'DISPID_SpeechWaveFormatEx', 'DISPID_SPRuleFirstElement',
    'ISpAudio', 'ISpeechVoice', 'SITooLoud', 'DISPID_SABufferInfo',
    'SP_VISEME_11', 'SAFTGSM610_44kHzMono', 'SPXMLRESULTOPTIONS',
    ...
    'SPRS_ACTIVE', 'SPPS_Noun', 'UINT_PTR', 'SPEI_SOUND_END',
    'IEnumString', 'SREAudioLevel',
    'SpeechPropertyHighConfidenceThreshold', 'DISPID_SRGState',
    'DISPID_SPIAudioSizeBytes', 'SSFMOpenForRead',
    'ISpGrammarBuilder',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet',
    'DISPID_SGRSTransitions', 'DISPID_SMSSetData', 'SpVoice',
    'DISPID_SPPsCount', 'SPFM_CREATE', 'ISpObjectTokenCategory',
    'DISPID_SADefaultFormat', 'SPPHRASEPROPERTY', 'DISPID_SPPParent',
    'STCLocalServer', 'SPSTREAMFORMATTYPE',
    'DISPID_SRRGetXMLErrorInfo', 'DISPID_SRGSetTextSelection',
    'SAFT22kHz16BitStereo', 'SAFTADPCM_11kHzStereo', 'SP_VISEME_12',
    'SPSVerb', 'SPEI_MAX_SR', 'SPEI_RECO_OTHER_CONTEXT',
    'DISPID_SVSPhonemeId', 'SPRECOCONTEXTSTATUS',
    'DISPID_SRAllowVoiceFormatMatchingOnNextSet',
    'DISPID_SRCVoicePurgeEvent', 'SpeechAudioVolume',
    'DISPID_SpeechPhraseBuilder', 'SPEI_RESERVED2',
    'SPDKL_DefaultLocation', 'eLEXTYPE_PRIVATE15', 'SVEViseme',
    'SAFTNonStandardFormat', 'DISPID_SASCurrentSeekPosition',
    'SP_VISEME_5', 'SAFT12kHz16BitStereo', 'SVSFParseMask',
    'SPAR_Medium', 'SLODynamic', 'DISPID_SGRSTPropertyValue',
    'eLEXTYPE_PRIVATE19', 'DISPID_SPIGetText',
    'SpeechPropertyComplexResponseSpeed', 'DISPID_SRRecognizer',
    'DISPID_SREmulateRecognition', 'DISPID_SVSVisemeId',
    'SAFTCCITT_uLaw_44kHzStereo',
    'DISPID_SPANumberOfElementsInResult', 'DISPID_SPILanguageId',
    'DISPID_SpeechLexiconWords', 'SPWT_LEXICAL', 'ISpPhoneConverter',
    'SRERequestUI', 'SPSFunction', 'DISPID_SRRTTickCount',
    'DISPID_SpeechDataKey', 'eLEXTYPE_VENDORLEXICON',
    'DISPID_SPERetainedStreamOffset', 'ISpeechRecognizer',
    'ISpeechPhraseProperties', 'SPSMF_UPS', 'DISPID_SGRsDynamic',
    'SRSActiveAlways', 'SVF_None', 'SFTSREngine', 'SGDSActive',
    'ISpeechXMLRecoResult', 'SpMMAudioEnum', 'SPINTERFERENCE_TOOSLOW',
    'SSTTTextBuffer', 'ISpPhoneticAlphabetSelection', 'eLEXTYPE_APP',
    'SP_VISEME_6', 'SVF_Stressed', 'DISPID_SPPEngineConfidence',
    ...
    'SpeechRecoEvents', 'SPCONTEXTSTATE', 'DISPID_SVRate',
    'SAFT32kHz8BitStereo', 'DISPID_SVEBookmark', 'ISpResourceManager',
    'DISPID_SGRSTs_NewEnum', 'SPSModifier', 'ISpStream',
    'ISpNotifySink', 'DISPID_SASetState', 'SpeechInterference',
    'eLEXTYPE_PRIVATE12', 'SLTUser', 'DISPID_SRCEventInterests',
    'SpeechAudioFormatType', 'DISPID_SOTCDefault', 'DISPID_SRGId',
    'IStream', 'SPPS_RESERVED2', 'DISPID_SPERetainedSizeBytes',
    'SRAImport', 'ISpPhraseAlt', 'SRTStandard',
    'DISPID_SVAlertBoundary', 'SPEI_ADAPTATION',
    ...
    'SVSFVoiceMask', 'DISPID_SGRSTType', 'DISPID_SPRFirstElement',
    'SGPronounciation', 'DISPID_SRRTStreamTime',
    'DISPID_SGRs_NewEnum', 'ISpSerializeState',
    'DISPID_SPRNumberOfElements', 'ISpeechMemoryStream',
    'SPSHORTCUTPAIR', 'DISPID_SBSRead', 'DISPID_SpeechRecoContext',
    'STSF_LocalAppData', 'DISPID_SRProfile',
    'DISPID_SRSSupportedLanguages', 'SpeechGrammarTagDictation',
    'SVP_21', 'DISPID_SRGCmdSetRuleIdState', 'SPEI_START_SR_STREAM',
    'DISPID_SRGetFormat', 'DISPID_SBSWrite', 'SAFTNoAssignedFormat',
    'SAFTADPCM_44kHzStereo', 'SPSHT_Unknown', 'DISPID_SVVoice',
    'SPBO_NONE', 'DISPID_SDKEnumValues', 'SGDSActiveWithAutoPause',
    'DISPID_SASNonBlockingIO', 'SPPS_Unknown', 'SINoise',
    'SPFM_OPEN_READWRITE', 'ISpXMLRecoResult', 'DISPID_SPIGrammarId',
    'DISPID_SPEActualConfidence', 'DISPID_SPEDisplayAttributes',
    'DISPID_SLWsItem', 'DISPID_SpeechAudioFormat', 'DISPID_SVSpeak',
    'DISPID_SVSyncronousSpeakTimeout', 'SRERecoOtherContext',
    'SpeechVoiceEvents', 'SPEI_START_INPUT_STREAM',
    'SpeechTokenIdUserLexicon', 'DISPID_SPRuleId', 'SRAORetainAudio',
    'DISPID_SGRSTPropertyId', 'DISPID_SpeechRecognizer',
    'SPEI_VOICE_CHANGE', 'SVP_9', 'ISpLexicon', 'SREPrivate',
    'SAFT8kHz16BitMono', 'DISPID_SPRules_NewEnum', 'DISPID_SAFGuid',
    'DISPID_SPPName', 'SpeechCategoryAudioOut', 'SAFT8kHz8BitMono',
    'SAFT32kHz16BitMono', 'eLEXTYPE_RESERVED6', 'SPSERIALIZEDRESULT',
    'DISPID_SpeechFileStream', 'SPINTERFERENCE_TOOFAST',
    'SVSFParseAutodetect', 'SRESoundEnd', 'SPEI_VISEME',
    'DISPID_SPAsCount', 'DISPID_SVSInputWordPosition',
    'DISPID_SRState', 'DISPID_SpeechLexiconWord', 'DISPID_SGRsCount',
    'DISPID_SAStatus', 'DISPID_SRRTOffsetFromStart',
    'DISPID_SpeechLexicon', 'SpeechAudioProperties', 'SREAdaptation',
    'SSTTWildcard', 'SpeechDictationTopicSpelling', 'SPEI_PHONEME',
    'DISPID_SGRSRule', 'DISPID_SPRulesCount', 'ISpDataKey',
    'SPWORDPRONUNCIATION', 'DISPID_SWFESamplesPerSec', 'SAFTDefault',
    'DISPID_SpeechPhraseElements', 'Speech_Max_Word_Length',
    'DISPID_SPELexicalForm', 'DISPID_SRCEEndStream',
    'ISpeechRecoContext', 'SPSHT_NotOverriden',
    'DISPID_SRSCurrentStreamNumber', 'ISpRecognizer', 'SFTInput',
    'ISpObjectToken', 'ISpRecognizer3', 'DISPID_SVSpeakStream',
    'DISPID_SLWPronunciations', 'DISPID_SVWaitUntilDone',
    'SPSHT_EMAIL', 'SPVPRI_OVER', 'SAFT32kHz16BitStereo',
    'SAFTCCITT_uLaw_8kHzStereo', 'SVEPrivate', 'SPWAVEFORMATTYPE',
    'SPCT_DICTATION', 'SPPS_RESERVED4', 'DISPID_SGRAddState',
    'DISPID_SpeechPhoneConverter', 'SECFIgnoreWidth', 'SpShortcut',
    'DISPID_SRGDictationUnload', 'DISPID_SRCEAdaptation',
    'ISpeechAudio', 'DISPID_SLAddPronunciationByPhoneIds',
    'SPRS_ACTIVE_WITH_AUTO_PAUSE', 'SAFTCCITT_ALaw_8kHzMono',
    'SPPS_Verb', 'SPEI_RESERVED5', 'DISPID_SLPLangId',
    'ISpeechObjectTokens', 'DISPID_SPIRule', 'DISPID_SpeechVoice',
    'STCRemoteServer', 'SP_VISEME_10', 'SpPhraseInfoBuilder',
    'eWORDTYPE_ADDED', 'DISPID_SVEWord', 'SPBO_AHEAD', 'SGSEnabled',
    'SpeechDisplayAttributes', 'SRESoundStart', 'SVP_19',
    'DISPID_SOTDisplayUI', 'DISPID_SPCIdToPhone',
    'SECFIgnoreKanaType', 'SPSUnknown', 'SVP_20',
    'SpeechRegistryLocalMachineRoot', 'SpeechCategoryAppLexicons',
    'DISPID_SRCBookmark', 'SVSFlagsAsync', 'SVP_0',
    'ISpeechGrammarRule', 'SpeechWordType',
    'DISPID_SVSpeakCompleteEvent', 'DISPID_SPPsItem', 'SPAR_Low',
    'DISPID_SDKOpenKey', 'SRSInactiveWithPurge', 'SDTRule',
    'ISpeechRecoResultDispatch', 'DISPID_SVSLastBookmark', 'SASRun',
    'SLTApp', 'SPEI_SR_BOOKMARK', 'ISpeechVoiceStatus',
    'DISPID_SOTIsUISupported', 'SDA_No_Trailing_Space',
    'DISPID_SGRClear', 'SPEI_UNDEFINED', 'DISPID_SRGetRecognizers',
    'DISPID_SVSLastResult', 'DISPID_SRAudioInputStream',
    'SVSFPersistXML', 'DISPID_SRGCmdLoadFromObject',
    'eLEXTYPE_PRIVATE20', 'SP_VISEME_13', 'SP_VISEME_20',
    'SPBO_PAUSE', 'DISPID_SVPause', 'SRAExport', 'SRADynamic',
    'SPEI_WORD_BOUNDARY', 'DISPID_SpeechGrammarRuleStateTransition',
    'DISPID_SPIEngineId', 'SASClosed', 'DISPID_SGRSTText',
    'SPRECORESULTTIMES', 'DISPID_SpeechPhraseRules',
    'DISPID_SpeechPhraseReplacements', 'ISpNotifyTranslator',
    'SpeechPartOfSpeech', 'ISpeechTextSelectionInformation',
    'DISPID_SRCEBookmark', 'SPSERIALIZEDPHRASE',
    'SPEI_END_INPUT_STREAM', 'SSSPTRelativeToCurrentPosition',
    'ISpeechObjectTokenCategory', 'SPEI_ACTIVE_CATEGORY_CHANGED',
    'SITooSlow', 'SDTAudio', 'DISPID_SpeechVoiceEvent',
    'DISPID_SLPPhoneIds', 'SAFTCCITT_ALaw_44kHzStereo', 'SPAS_RUN',
    'SVP_17', 'SVESentenceBoundary', 'SP_VISEME_19',
    'SAFT11kHz8BitMono', 'SpeechVisemeFeature',
    'SPEI_RECO_STATE_CHANGE', 'SPEI_RESERVED1', 'ISpeechMMSysAudio',
    'SAFT11kHz16BitStereo', 'DISPID_SpeechMemoryStream',
    'SPSInterjection', 'ISpNotifySource', 'SP_VISEME_0',
    'SPEI_SENTENCE_BOUNDARY', 'SRTAutopause', 'SPEVENTENUM',
    'SPLEXICONTYPE', 'SPVISEMES', 'SpeechAddRemoveWord',
    'SPFM_NUM_MODES', 'DISPID_SPRuleNumberOfElements',
    'SpObjectTokenCategory', 'SPGS_ENABLED', '__MIDL_IWinTypes_0009',
    'SPAO_NONE', 'DISPID_SpeechAudio', 'DISPID_SPIRetainedSizeBytes',
    'DISPID_SPARecoResult', 'SVSFIsNotXML', 'SAFTADPCM_11kHzMono',
    'DISPID_SRGetPropertyString', 'SSTTDictation', 'SPWORD',
    'SPFILEMODE', 'SVEStartInputStream', 'SpeechTokenKeyFiles',
    'SpeechTokenKeyAttributes', 'SPEI_TTS_BOOKMARK',
    'SAFTCCITT_ALaw_8kHzStereo', 'DISPID_SVEPhoneme',
    'DISPID_SRCAudioInInterferenceStatus', 'SDTReplacement',
    'SASStop', 'SPEVENT', 'SVP_11', 'DISPID_SDKGetBinaryValue',
    'DISPID_SPIProperties', 'SPPROPERTYINFO',
    'DISPID_SpeechPhraseInfo', 'SPAR_Unknown',
    'ISpeechPhraseReplacement', 'DISPID_SDKGetStringValue',
    'DISPIDSPTSI_ActiveOffset', 'SVP_2', 'DISPID_SPRs_NewEnum',
    'SPINTERFERENCE_NONE', 'SPGRAMMARWORDTYPE', 'SpInprocRecognizer',
    'SGRSTTWord', 'ISpeechObjectToken', 'SPPS_Noncontent',
    'SPCS_ENABLED', 'eLEXTYPE_RESERVED7', 'eLEXTYPE_PRIVATE7',
    'DISPID_SMSGetData', 'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C',
    'SPPHRASEREPLACEMENT', 'SWTAdded', 'SECLowConfidence',
    ...
    'DISPID_SGRAttributes', 'SVP_13', 'SAFTGSM610_22kHzMono',
    'SAFTCCITT_ALaw_44kHzMono', 'DISPID_SpeechGrammarRule',
    'SWPKnownWordPronounceable', 'ISpPhrase', 'SpAudioFormat',
    'SPCT_COMMAND', 'SVP_18', 'SREPropertyNumChange',
    'SpeechAllElements',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'DISPID_SRGCmdLoadFromFile', 'SpeechDataKeyLocation',
    'DISPID_SPAPhraseInfo', 'eLEXTYPE_RESERVED10', 'SVSFIsXML',
    'SVSFUnusedFlags', 'SPPS_RESERVED1', 'SPAO_RETAIN_AUDIO',
    'STCInprocHandler', 'SVEAudioLevel', 'DISPID_SRGRecoContext',
    'DISPID_SVAudioOutput', 'SGDSInactive', 'DISPID_SGRSTNextState',
    'SSFMCreate', 'DISPID_SPRsCount', 'SECFNoSpecialChars',
    'SpFileStream', 'SPBINARYGRAMMAR',
    'DISPID_SpeechLexiconPronunciation', 'DISPID_SABIMinNotification',
    'SP_VISEME_15', 'DISPID_SpeechRecoContextEvents',
    'ISpeechRecoGrammar', 'SVP_3', 'DISPID_SWFEBlockAlign',
    'SPLO_STATIC', 'SpStream', 'eLEXTYPE_RESERVED9',
    'DISPID_SVSInputWordLength', 'ISpeechLexicon',
    'Speech_StreamPos_RealTime', 'SPXRO_Alternates_SML',
    'DISPID_SOTsItem', 'SPXRO_SML', 'IEnumSpObjectTokens',
    'SpeechAudioState', 'DISPID_SRCVoice', 'DISPID_SOTs_NewEnum',
    'DISPID_SRGRules', 'SAFT44kHz16BitMono',
    'DISPID_SAFGetWaveFormatEx', 'SRTExtendableParse',
    'DISPID_SGRSTsCount', 'SpeechRuleState',
    'DISPID_SOTCEnumerateTokens', 'ISpRecognizer2',
    'DISPID_SPEAudioSizeTime', 'eLEXTYPE_PRIVATE5', 'SVP_15',
    'SREPropertyStringChange', 'DISPID_SLPsCount',
    'eLEXTYPE_PRIVATE9', 'SPSNoun', 'SPVPRI_ALERT',
    ...
    'SPRECOSTATE', 'SVEEndInputStream', 'SP_VISEME_17',
    'DISPID_SLAddPronunciation', 'SVSFParseSsml', 'SDTPronunciation',
    'DISPID_SPPChildren', 'DISPID_SLWLangId',
    'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE',
    'SAFTTrueSpeech_8kHz1BitMono', 'SPSNotOverriden',
    'ISpeechPhraseReplacements', 'SVEPhoneme',
    'DISPID_SpeechVoiceStatus', 'DISPID_SWFEAvgBytesPerSec',
    'DISPID_SRRSetTextFeedback', 'SPVOICESTATUS',
    ...
    'SAFTCCITT_uLaw_11kHzStereo', 'SRSInactive', 'SPRST_NUM_STATES',
    'DISPID_SPAs_NewEnum', 'eLEXTYPE_PRIVATE13', 'DISPID_SRGReset',
    'SPEI_SR_RETAINEDAUDIO', 'SPPS_NotOverriden', 'eLEXTYPE_PRIVATE6',
    'DISPID_SOTRemoveStorageFileName', 'SPRST_INACTIVE', 'SPPS_LMA',
    'DISPID_SRSCurrentStreamPosition', 'DISPID_SLWs_NewEnum',
    'SREFalseRecognition', 'SpeechLexiconType', 'DISPID_SPEsItem',
    'SpeechVoiceCategoryTTSRate', 'SRSEIsSpeaking',
    ...
    'DISPID_SPPBRestorePhraseFromMemory', 'SDTProperty',
    'DISPID_SPRulesItem', 'SAFT48kHz16BitStereo',
    'SSSPTRelativeToStart', 'SREHypothesis',
    'DISPID_SGRSAddWordTransition', 'SVP_4',
    'DISPID_SpeechPhraseAlternate', 'SPPARTOFSPEECH',
    'SpeechRegistryUserRoot', 'SPEI_TTS_PRIVATE', 'DISPID_SGRsAdd',
    'DISPID_SRSClsidEngine', 'DISPID_SGRSTPropertyName',
    'SP_VISEME_7', 'SAFTGSM610_8kHzMono', 'STSF_CommonAppData',
    'SPFM_OPEN_READONLY', 'DISPID_SLPType',
    'SpeechGrammarTagWildcard', 'DISPID_SPIStartTime', 'SPPHRASE',
    'DISPID_SRGDictationSetState', 'SPEI_MIN_TTS',
    'SpUnCompressedLexicon', 'SRAONone', 'SITooFast',
    'SSSPTRelativeToEnd', 'SPEI_SR_PRIVATE',
    'SAFTCCITT_ALaw_22kHzStereo', 'SpeechLoadOption',
    'SAFTGSM610_11kHzMono', 'DISPID_SRRAlternates', 'SPPS_RESERVED3',
    'SAFTADPCM_44kHzMono', 'SVP_6', 'tagSPPROPERTYINFO',
    'DISPID_SPRuleChildren', 'SITooQuiet', 'SPWT_PRONUNCIATION',
    'SPEI_REQUEST_UI', 'DISPIDSPRG',
    '__MIDL___MIDL_itf_sapi_0000_0020_0001', 'ISpeechWaveFormatEx',
    'SpeechWordPronounceable', 'SDTAll', 'SAFTExtendedAudioFormat',
    'SpeechCategoryRecognizers', 'STSF_FlagCreate', 'SPCT_SLEEP',
    'DISPID_SOTGetStorageFileName', 'DISPID_SVSInputSentencePosition',
    'DISPID_SDKCreateKey', 'DISPID_SVPriority', 'ISpRecoGrammar',
    'SVEAllEvents', 'DISPID_SRRAudioFormat',
    'DISPID_SRCEInterference', 'DISPIDSPTSI', 'SPRULESTATE',
    'SPINTERFERENCE_NOISE', 'SAFT16kHz16BitMono', 'eLEXTYPE_PRIVATE1',
    'DISPID_SPEEngineConfidence', 'DISPID_SRIsUISupported',
    'SPDKL_CurrentUser', 'SPGRAMMARSTATE', 'DISPID_SOTId',
    ...
    'DISPID_SpeechMMSysAudio', 'DISPID_SpeechPhraseAlternates',
    'DISPID_SRGetPropertyNumber', 'SPAUDIOBUFFERINFO',
    'DISPID_SVStatus', 'DISPID_SRGCmdSetRuleState',
    'ISpeechAudioBufferInfo', 'DISPID_SGRSAddRuleTransition',
    'ISpeechLexiconWords', 'SPAUDIOSTATUS', 'SPSEMANTICERRORINFO',
    'SpeechMicTraining', 'ISpeechGrammarRuleState',
    'DISPID_SRCResume', 'DISPID_SGRSTsItem',
    'DISPID_SGRsCommitAndSave', 'DISPID_SGRsItem', 'SVP_7',
    'DISPID_SpeechXMLRecoResult', 'DISPID_SPRuleConfidence',
    'DISPID_SRAudioInput', 'DISPID_SASFreeBufferSpace',
    'SPRST_INACTIVE_WITH_PURGE', 'DISPID_SRCRetainedAudio',
    'SPAS_CLOSED', 'DISPID_SRCCreateGrammar', 'ISpObjectWithToken',
    'DISPID_SPIAudioStreamPosition', 'DISPID_SRCRequestedUIType',
    'SAFTCCITT_uLaw_11kHzMono', 'SpeechTokenValueCLSID',
    'DISPID_SPEs_NewEnum', 'DISPID_SAFSetWaveFormatEx',
    'SAFT16kHz8BitStereo', 'SPDKL_CurrentConfig', 'SAFT44kHz8BitMono',
    'SDKLLocalMachine', 'SpeechVoiceSkipTypeSentence', 'SRSEDone',
    'DISPID_SLPSymbolic', 'DISPID_SVEVoiceChange',
    'SPEI_PHRASE_START', 'DISPID_SRStatus', 'DISPID_SVEStreamEnd',
    'SRTSMLTimeout', 'SP_VISEME_18', 'SVP_14',
    'DISPID_SVGetAudioOutputs', 'DISPID_SPRuleParent', 'SVP_5',
    'SAFT11kHz8BitStereo', 'ISpeechPhraseRules', 'SRARoot',
    'DISPID_SRGCommit', '_SPAUDIOSTATE', 'DISPID_SPPId',
    'ISpeechResourceLoader', 'eLEXTYPE_RESERVED4',
    'DISPID_SpeechBaseStream', 'SpCustomStream', 'SAFTADPCM_8kHzMono',
    'DISPID_SOTMatchesAttributes', 'SPEI_PROPERTY_STRING_CHANGE',
    'DISPID_SDKEnumKeys', 'DISPID_SPCPhoneToId', 'SPPS_Modifier',
    'DISPID_SRCRecognizer', 'SpPhoneticAlphabetConverter',
    'SAFT12kHz16BitMono', 'DISPID_SpeechRecoResult',
    'SPDKL_LocalMachine', 'SAFTCCITT_uLaw_22kHzStereo',
    'eLEXTYPE_PRIVATE10', 'SpeechFormatType',
    'SpeechCategoryPhoneConverters', 'SpeechRecoContextState',
    'DISPID_SVEEnginePrivate', 'DISPID_SRGCmdLoadFromResource',
    'SREStreamStart', 'DISPID_SLPs_NewEnum', 'SAFTADPCM_22kHzMono',
    'DISPID_SOTRemove', 'SECFDefault', 'ISpeechPhraseAlternates',
    'SDA_Consume_Leading_Spaces', 'SPTEXTSELECTIONINFO',
    'SAFT44kHz8BitStereo', 'DISPID_SPRuleEngineConfidence',
    'SVEBookmark', 'SPGS_EXCLUSIVE', 'DISPID_SLWsCount',
    'ISpeechPhraseRule', 'SPINTERFERENCE_TOOQUIET',
    'SPSHORTCUTPAIRLIST', 'SAFT48kHz8BitMono', 'SPVPRIORITY',
    'DISPID_SFSClose', 'DISPID_SASState', 'ISpeechPhraseAlternate',
    'SRCS_Enabled', 'DISPID_SFSOpen', 'ISpRecoContext2',
    'SAFT22kHz16BitMono', 'DISPID_SPIElements',
    'SGDSActiveUserDelimited', 'DISPID_SLPsItem',
    'DISPID_SASCurrentDevicePosition', 'SpResourceManager',
    ...
    'SPSMF_SRGS_SEMANTICINTERPRETATION_MS', 'SVSFPurgeBeforeSpeak',
    'SVSFNLPMask', 'SPAS_PAUSE', 'SRERecognition',
    'SpeechSpecialTransitionType', 'eLEXTYPE_MORPHOLOGY',
    'ISpStreamFormatConverter', 'DISPID_SPPs_NewEnum',
    'DISPID_SAFType', 'SPWORDPRONUNCIATIONLIST',
    'DISPID_SPPNumberOfElements', 'SpeechPropertyAdaptationOn',
    'DISPID_SRCPause', 'STCAll', 'DISPID_SWFEExtraData',
    'DISPID_SDKDeleteKey', 'DISPID_SPIAudioSizeTime', 'SPWT_DISPLAY',
    'SRADefaultToActive', 'SVSFParseSapi', 'SVPNormal',
    'DISPID_SDKDeleteValue', 'SREInterference',
    'DISPID_SpeechRecoResult2', 'SpeechUserTraining',
    'SPSSuppressWord', 'SGRSTTDictation', 'SRSActive',
    'SAFT16kHz8BitMono', 'DISPID_SMSADeviceId', 'SVEWordBoundary',
    'ISpeechRecoResultTimes', 'DISPID_SRCEPropertyStringChange',
    'SAFTCCITT_uLaw_8kHzMono', 'DISPID_SpeechLexiconProns',
    'SpMMAudioIn', 'ISpeechDataKey', 'SSFMOpenReadWrite',
    'SpeechCategoryRecoProfiles', 'SPWORDLIST',
    'DISPID_SRCCmdMaxAlternates', 'SVPOver', 'SPSEMANTICFORMAT',
    'SPBOOKMARKOPTIONS', 'SP_VISEME_4', 'ISpeechAudioFormat',
    'DISPID_SVEventInterests', 'SPINTERFERENCE_NOSIGNAL',
    'DISPID_SPRsItem', 'ISpShortcut', 'SPLO_DYNAMIC',
    'SAFT32kHz8BitMono', 'SPEI_RECOGNITION', 'DISPID_SGRSTRule',
    'SpeechStreamSeekPositionType', 'DISPID_SRIsShared',
    'DISPID_SVEViseme', 'DISPID_SVSInputSentenceLength',
    'ISpRecoResult', 'SpeechGrammarWordType', '_ISpeechVoiceEvents',
    'SRATopLevel', 'SECFEmulateResult', 'DISPID_SPPConfidence',
    'SpeechRecognitionType', 'DISPID_SGRInitialState',
    'DISPID_SRRGetXMLResult', 'SSFMCreateForWrite', 'SPEI_RESERVED6',
    'SVP_10', 'Speech_Max_Pron_Length',
    'DISPID_SLRemovePronunciationByPhoneIds', 'SPPS_Interjection',
    'DISPID_SRRRecoContext', 'SPCS_DISABLED',
    'SDA_Two_Trailing_Spaces', 'Speech_Default_Weight',
    'DISPID_SWFEChannels', 'DISPID_SMSAMMHandle', 'SPSHT_OTHER',
    'SPINTERFERENCE_LATENCY_TRUNCATE_END', 'ISpRecoCategory',
    'DISPID_SRSetPropertyNumber', 'SpNotifyTranslator',
    'SPGS_DISABLED', 'DISPID_SVESentenceBoundary', 'ISpRecoContext',
    'SECHighConfidence', 'SPEI_INTERFERENCE',
    'DISPID_SPEAudioStreamOffset', 'DISPID_SOTGetAttribute',
    'SP_VISEME_14', 'SVP_12', 'DISPID_SPRDisplayAttributes',
    'SAFTADPCM_22kHzStereo', 'SPEI_PROPERTY_NUM_CHANGE',
    'DISPID_SRCERecognition', 'DISPID_SOTCId', 'SPEI_MIN_SR',
    'SPPHRASERULE', 'DISPID_SPRText', 'eLEXTYPE_PRIVATE4',
    'eLEXTYPE_PRIVATE14', 'DISPID_SLGenerationId', 'SVF_Emphasis',
    'SPRS_ACTIVE_USER_DELIMITED', 'DISPID_SMSALineId',
    'SPWF_SRENGINE', 'ISpeechPhraseElement',
    'DISPID_SLGetPronunciations', 'SAFT24kHz8BitStereo',
    'SAFTCCITT_ALaw_11kHzStereo', 'SPEVENTSOURCEINFO', 'SLOStatic',
    'DISPID_SOTCGetDataKey', 'ISpeechCustomStream', 'ISpProperties',
    'IInternetSecurityMgrSite', 'SRAInterpreter',
    'SAFT44kHz16BitStereo', 'SpeechVoicePriority', 'SVSFDefault',
    'DISPID_SPRuleName', 'DISPID_SPPFirstElement',
    'DISPID_SLGetWords', 'DISPID_SVAudioOutputStream',
    'SpWaveFormatEx', 'DISPID_SLRemovePronunciation',
    'DISPID_SGRAddResource', 'DISPID_SpeechObjectTokens',
    'SPAUDIOOPTIONS', 'SPEI_MAX_TTS', 'DISPID_SBSFormat',
    'DISPID_SBSSeek', 'DISPID_SRGDictationLoad', 'SPDATAKEYLOCATION',
    'DISPID_SLGetGenerationChange', 'SREPhraseStart', 'SpLexicon',
    'eLEXTYPE_PRIVATE11', 'SPPS_Function', 'SpeechEngineConfidence',
    'DISPID_SDKGetlongValue', 'DISPID_SRCreateRecoContext',
    'DISPID_SOTsCount', 'SAFT22kHz8BitStereo', 'SPRULE', 'SPWORDTYPE',
    'SPADAPTATIONRELEVANCE', 'DISPID_SRCESoundEnd', 'DISPID_SPPValue',
    'eLEXTYPE_PRIVATE3', 'SDTAlternates', 'SREBookmark',
    'DISPID_SOTDataKey', 'SPWORDPRONOUNCEABLE', 'ISpMMSysAudio',
    'SREStateChange', 'eLEXTYPE_PRIVATE2',
    'DISPIDSPTSI_SelectionLength', 'DISPID_SRGCmdLoadFromMemory',
    ...
    'DISPID_SpeechPhraseElement', 'SVP_1', 'SRTEmulated',
    'SAFTCCITT_uLaw_44kHzMono', 'DISPID_SRCESoundStart', 'SP_VISEME_9'
]
